...
def generatePublicKey(totient):
    public_key = random.randrange(3, totient - 1)
    while not (genLargePrimes.is_prime(public_key) and genLargePrimes.is_coprime(public_key, totient)):
        public_key += 1
    print("Generate public key: ", public_key)
